...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { image: @tour.image, location: @tour.location, price: @tour.price, title: @tour.title }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { image: @tour.image, location: @tour.location, price: @tour.price, title: @tour.title }
    assert_redirected_to tour_path(assigns(:tour))
  end
